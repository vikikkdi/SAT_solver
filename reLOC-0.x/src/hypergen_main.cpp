...
/*                                                                            */
/*============================================================================*/
/* hypergen_main.cpp / 0.21-robik_020                                         */
/*----------------------------------------------------------------------------*/
//
...
/*----------------------------------------------------------------------------*/
    ...
    {
	printf("================================================================\n");
	printf("%s : Hyper-cube Instance Generator\n", sPRODUCT);
	printf("%s\n", sCOPYRIGHT);
	printf("----------------------------------------------------------------\n");
    }
    ...
    {
	printf("Usage:\n");
	printf("hypergen_reLOC  --dimmension=<int>\n");
	printf("                --alen=<int>\n");
	printf("                --min-alen=<int>\n");
	printf("                --max-alen=<int>\n");
	printf("                --N-robots=<int>\n");
	...
	printf("\n");
	printf("Examples:\n");
	printf("hypergen_reLOC --dimmension=3\n");
	printf("               --N-robots=5\n");
	printf("               --N-goals=2\n");
	printf("               --seed=12345\n");
	...
	else
	{
	    ...
	    {
		environment.generate_Hypercube(parameters.m_dimmension, parameters.m_aisle_length);
	    }
	    else
	    {
		if (parameters.m_min_aisle_length != -1 && parameters.m_max_aisle_length != -1)
		{
		    environment.generate_Hypercube(parameters.m_dimmension, parameters.m_min_aisle_length, parameters.m_max_aisle_length);
		}
	    }
	}
    ...
    {
	if (parameter.find("--dimmension=") == 0)
	{
	    command_parameters.m_dimmension = sInt_32_from_String(parameter.substr(13, parameter.size()));
	}
