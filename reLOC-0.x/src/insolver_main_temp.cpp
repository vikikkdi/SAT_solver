...
/*                                                                            */
/*============================================================================*/
/* insolver_main_temp.cpp / 0.21-robik_020                                    */
/*----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------*/
    ...
    {
	printf("Usage:\n");
	printf("insolver_reLOC  --input-file=<string>\n");
	...
	printf("	                  tmdd|tmmdd|temdd|temmdd|pmdd|pmmdd\n");
	...
	printf("\n");
	printf("Examples:\n");
	printf("insolver_reLOC --input-file=grid_02.txt\n");
